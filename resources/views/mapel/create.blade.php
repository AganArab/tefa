...
@section('atas', 'Tambah Mata Pelajaran')
@section('judul', 'Form Tambah Mata Pelajaran')
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="kode" class="form-control @error('kode') is-invalid @enderror"
                        value="{{ old('kode') }}" placeholder="Masukkan kode (opsional)">
                    @error('kode')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <select name="guru_pengajar_id" class="form-control @error('guru_pengajar_id') is-invalid @enderror">
                        ...
                        @foreach($gurus as $g)
                            <option value="{{ $g->id }}" {{ old('guru_pengajar_id') == $g->id ? 'selected' : '' }}>
                                {{ $g->nama }}
                            </option>
                        @endforeach
                    </select>
